...
فهرست کامل تمام endpoint ها (احراز هویت، 2FA، API Key، کسب‌وکار، حساب‌ها، تراکنش‌ها، بودجه، اهداف، تراکنش تکرارشونده، چک، پیام بانکی، پرداخت زرین‌پال، هشدار، داشبورد، گزارش، بک‌آپ) در **[docs/API_SPEC.md](docs/API_SPEC.md)** آمده است.
