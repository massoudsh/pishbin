...
- **مدیریت چک** (صادره/دریافتی) با وضعیت وصول، شماره صیادی، و اتصال سررسید به پیش‌بینی جریان نقدی
...
فهرست کامل تمام endpoint ها (احراز هویت، 2FA، API Key، کسب‌وکار، حساب‌ها، تراکنش‌ها، بودجه، اهداف، تراکنش تکرارشونده، چک، آشتی‌سازی بانکی، پیام بانکی، پرداخت زرین‌پال، هشدار، داشبورد، گزارش، بک‌آپ) در **[docs/API_SPEC.md](docs/API_SPEC.md)** آمده است.
